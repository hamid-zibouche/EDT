...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 26 mai 2022 à 21:35
...
(3, 'ZIBOUCHE', 'Hamid', 'hamidzibouche1@gmail.com', '2001-12-23', 54);
...
--
ALTER TABLE `disponibilité_lieux`
  MODIFY `id_dis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;
...
--
ALTER TABLE `etudiant`
  MODIFY `id_etd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `seance`
  MODIFY `id_sea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;
