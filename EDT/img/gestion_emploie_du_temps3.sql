...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 26 mai 2022 à 00:01
...
--
ALTER TABLE `disponibilité_lieux`
  MODIFY `id_dis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;
...
--
ALTER TABLE `seance`
  MODIFY `id_sea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=255;
