...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 25 mai 2022 à 02:12
...
(1, 'admin', 'admin', 'admin'),
(1, 'ens', 'AKILAL_Karim', 'Karim1980-05-11'),
(2, 'etd', 'ZIBOUCHE_Hamid', 'Hamid2001-12-23'),
(2, 'ens', 'GADOUCHE_Sarah', 'Sarah1983-05-17'),
(3, 'etd', 'DEBICHE_Hakim', 'Hakim2000-04-12'),
(3, 'ens', 'KABYLE_Jamel', 'Jamel1980-05-04'),
(4, 'etd', 'ALICHE_Yazid', 'Yazid2001-10-28'),
(4, 'ens', 'AISSANI_Hassane', 'Hassane1982-05-10'),
(5, 'etd', 'ALICHE_GHILES', 'GHILES2001-10-21'),
(10, 'ens', 'TALEM_Djamel', 'Djamel1980-05-24');
...
--
ALTER TABLE `disponibilité_lieux`
  MODIFY `id_dis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;
...
--
ALTER TABLE `edt_ens`
  MODIFY `id_ed_ens` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `lieux`
  MODIFY `id_lieux` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `module`
--
ALTER TABLE `module`
  MODIFY `id_mod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `seance`
  MODIFY `id_sea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
