...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 12 juin 2022 à 17:13
...
CREATE TABLE `seance` (
  ...
  `lib_sem` enum('S1','S2','S3','S4','S5','S6','S7','S8','S9','10','') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `T_dispo_enseignant` AFTER INSERT ON `seance` FOR EACH ROW insert into disponibilité_enseignant VALUES('',new.jour,new.heure_debut,new.heure_fin,new.id_ens,new.lib_sem)
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `T_dispo_lieux` AFTER INSERT ON `seance` FOR EACH ROW insert into disponibilité_lieux values('',new.jour,new.heure_debut,new.heure_fin,new.id_lieux,new.lib_sem)
$$
DELIMITER ;
DELIMITER $$
...
(7, 'ens', 'BOUKERAM_Karima', 'Karima1978-02-17'),
...
--
ALTER TABLE `disponibilité_enseignant`
  MODIFY `id_dis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=276;

--
-- AUTO_INCREMENT pour la table `edt`
--
ALTER TABLE `edt`
  MODIFY `id_edt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `enseignant`
  MODIFY `id_ens` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;

--
-- AUTO_INCREMENT pour la table `etudiant`
--
ALTER TABLE `etudiant`
  MODIFY `id_etd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `groupe`
  MODIFY `id_grp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `seance`
  MODIFY `id_sea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=534;
