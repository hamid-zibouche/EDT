<option value="" selected disabled  required> CHOISIR SEMESTRE </option>  
...
$semestre = $mysqlClient->prepare("SELECT lib_sem, id_sem from semestre where id_for = $formation ");
$semestre->execute();
