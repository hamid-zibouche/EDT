        ...
        <ul>
            ...
            <li><a href="">Formation</a>
                <ul>
                    ...
                    <li><a href="../phpAet/./viewformation.php">Gestions des formations</a></li>
                    <li><a href="../../apprendre/formation/ajtformation.php">Ajouter Formation</a></li>
                </ul>
            </li>
            <li><a href="">Semestre</a>
            <ul>
               <li>   <a href="../../apprendre/semestre/ajtsemestre.php"> Ajouter Semestre </a> </li>
                <li><a href="../../apprendre/semestre/supsemestre.php">Supprimer Semestre </a> </li>
            </ul>
           </li>
            ...
            <li><a href="">Enseignant</a>
                <ul>
                    <li><a href="../../gestionENS/./listeENS.php">Liste Enseignant</a></li>
                    <li><a href="../../gestionENS/./CreateEns.php">Ajouter un Enseignant</a></li>
                    <li><a href="">Disponibilité</a></li>
                    <li><a href="">Module Enseigés</a></li>
                </ul>
            </li>
            <li><a href="">Etudiant</a>
                <ul>
                    <li><a href="../phpAet/./viewEtudiant.php">Gestion des Etudiantes</a></li>
                    <li><a href="../phpAet/./gestionEnseignant.php">Ajouter un Etudiant</a></li>
                </ul>
            </li>
            <li><a href="">Module</a>
                <ul>
            ...
            <li><a href="">Lieux</a>
                <ul>
                    <li><a href="../phpAet/./viewlieu.php">Liste Lieux</a></li>
                    <li><a href="../../apprendre/./lieux/./addLieux.php">Ajouter Lieux</a></li>
                </ul>
            </li>
